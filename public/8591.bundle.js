"use strict";(self.webpackChunksigor=self.webpackChunksigor||[]).push([[8591],{28591:(e,t,i)=>{i.r(t),i.d(t,{AppKitModal:()=>ge,W3mModal:()=>ve,W3mModalBase:()=>me});var o=i(12618),a=i(62745),r=i(60031),s=i(24376),n=i(42733),c=i(84833),l=i(6056),w=i(36010),d=i(88249),p=i(78508),u=i(28201);const h={isUnsupportedChainView:()=>"UnsupportedChain"===p.I.state.view||"SwitchNetwork"===p.I.state.view&&p.I.state.history.includes("UnsupportedChain"),async safeClose(){this.isUnsupportedChainView()||await u.U.isSIWXCloseDisabled()?c.W.shake():c.W.close()}};var m=i(68996),v=i(21871),g=i(26742),y=i(75236),f=i(26109),b=i(43494);const k=o.AH`
  :host {
    display: block;
...
`;var M=function(e,t,i,o){var a,r=arguments.length,s=r<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(s=(r<3?a(s):r>3?a(t,i,s):a(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};let B=class extends o.WF{constructor(){super(...arguments),this.imageSrc=""}render(){return o.qy`<button>
    ...
    ></wui-icon-box>`}};B.styles=[f.W5,f.fD,f.ck,H],M([(0,a.MZ)()],B.prototype,"imageSrc",void 0),B=M([(0,b.E)("wui-select")],B),i(5752),i(45090);var L=i(42606);const z=o.AH`
  :host {
    height: 64px;
  }
